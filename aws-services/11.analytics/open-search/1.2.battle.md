...
## Related Notes
- [[aws-services/11.analytics/open-search/1.1.elastic-search|Elasticsearch]] - previous lesson
- [[aws-services/11.analytics/open-search/2.aws-open-search|Amazon OpenSearch Service]] - next lesson
