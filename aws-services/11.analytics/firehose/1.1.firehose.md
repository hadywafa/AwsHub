...
<div style="text-align: center;">
  <img src="images/aws-firehose-overview.png" alt="aws-firehose" style="border-radius: 10px; width: 90%" />
</div>
...
<div style="text-align: center;">
  <img src="images/aws-firehose.png" alt="aws-firehose" style="border-radius: 10px; width: 90%" />
</div>
