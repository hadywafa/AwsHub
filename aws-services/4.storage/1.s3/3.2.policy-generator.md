...
- [[aws-services/4.storage/1.s3/3.1.access-policies|Amazon S3 Access Policies]] - previous lesson
- [[aws-services/4.storage/1.s3/4.1.multi-upload|Amazon S3 Multipart Uploads]] - next lesson
- [[aws-services/2.security/1.1.iam/1.fundmmentals/4.2.policy-generator|AWS Policy Generator]] - mentions AWS Policy Generator
