...
- [[aws-services/4.storage/1.s3/2.4.lifecycle-policies|Amazon S3 Storage Classes Lifecycle Policies Made Easy]] - previous lesson
- [[aws-services/4.storage/1.s3/3.1.access-policies|Amazon S3 Access Policies]] - next lesson
