...
tags:
  ...
  - aws/topic/ecr
aliases:
  - "Amazon ECR Private Registry Feature Settings Explained"
  - "ECR Features Settings"
---
...
- [[aws-services/6.containers/1.ecr/1.2.private-vs-public-registry|Private vs. Public Container Registries + ECR Public Gallery]] - previous lesson
- [[aws-services/6.containers/1.ecr/2.2.ecr-features-settings-examples|Amazon ECR Private Registry Feature Settings & Real-World Use Cases]] - next lesson
