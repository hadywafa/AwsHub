...
aliases:
  - "How AWS CodeBuild Works Internally"
  - "Codebuild"
---
...
- [[aws-services/10.developer/2.2.code-build/1.2.build-project|How AWS CodeBuild Works Internally with Full Build Project Setup]] - next lesson
