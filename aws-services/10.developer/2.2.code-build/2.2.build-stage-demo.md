...
aliases:
  - "Mastering the Build Stage in CI/CD"
  - "Build Stage Demo"
---
...
- [[aws-services/10.developer/2.2.code-build/2.1.buildspec.yml|AWS CodeBuild buildspec.yml]] - previous lesson
- [[aws-services/10.developer/2.2.code-build/2.3.artifacts-extra|Full Guide Understanding artifacts in buildspec.yml for AWS CodeDeploy]] - next lesson
- [[aws-services/10.developer/2.2.code-build/3.1.build-caching|CodeBuild Caching]] - mentions CodeBuild Caching
