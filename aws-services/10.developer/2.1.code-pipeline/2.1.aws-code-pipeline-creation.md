...
aliases:
  - "AWS CodePipeline Creating Your First Pipeline from Scratch"
...
- [[aws-services/10.developer/2.1.code-pipeline/1.2.code-pipeline-supported-deploy-providers|All Supported CodePipeline Deploy Providers as of now]] - previous lesson
- [[aws-services/10.developer/2.1.code-pipeline/3.1.source-stage|AWS CodePipeline Source Stage]] - next lesson
