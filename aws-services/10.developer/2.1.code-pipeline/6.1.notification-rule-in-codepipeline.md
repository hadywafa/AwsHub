...
aliases:
  ...
  - "Notification Rule In Codepipeline"
---
...
- [[aws-services/10.developer/2.1.code-pipeline/5.multi-region|AWS CodePipeline Multi-Region Deployments with CloudFormation]] - previous lesson
- [[aws-services/10.developer/2.1.code-pipeline/6.2.manual-approval-stage|Adding Manual Approval to AWS CodePipeline]] - next lesson
