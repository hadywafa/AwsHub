...
- [[aws-services/10.developer/2.1.code-pipeline/3.2.2.s3-bucket-connection|AWS CodePipeline with Amazon S3 Source Updated for 2025]] - previous lesson
- [[aws-services/10.developer/2.1.code-pipeline/3.3.1.third-party-source-providers|Change Detection with Third-Party Source Providers in CodePipeline GitHub GitLab Bitbucket]] - next lesson
