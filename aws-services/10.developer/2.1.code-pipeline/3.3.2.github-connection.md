...
- [[aws-services/10.developer/2.1.code-pipeline/3.3.1.third-party-source-providers|Change Detection with Third-Party Source Providers in CodePipeline GitHub GitLab Bitbucket]] - previous lesson
- [[aws-services/10.developer/2.1.code-pipeline/3.3.3.git-triggers-and-filtering|AWS CodePipeline Triggers Automate Your CI/CD]] - next lesson
