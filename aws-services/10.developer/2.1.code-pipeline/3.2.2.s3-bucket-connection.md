...
- [[aws-services/10.developer/2.1.code-pipeline/3.2.1.first-party-source-providers|How AWS Source Providers Trigger CodePipeline Using EventBridge]] - previous lesson
- [[aws-services/10.developer/2.1.code-pipeline/3.2.3.aws-ecr-connection|AWS CodePipeline & Amazon ECR Integration Using EventBridge]] - next lesson
