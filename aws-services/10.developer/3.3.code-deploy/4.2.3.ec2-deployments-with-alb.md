...
-[[4.2.2.streaming-logs-for-ec2-deployment|7.2. Streaming Deployment Logs for EC2 Instance Deployments with AWS CodeDeploy]]] - previous lesson
-[[4.4.1.blue-green-deployment|Mastering CodeDeploy Deployment Types Focus on Blue/Green]]] - next lesson
- [[aws-services/5.compute/1.3.ec2-auto-scaling/1.1.ec2-auto-scaling|EC2 Auto Scaling]] - mentions EC2 Auto Scaling
-[[4.1.1.ec2-deployments|AWS CodeDeploy with EC2 Deployments]]] - mentions EC2 Deployments
