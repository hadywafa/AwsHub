...
aliases:
  - "Using CloudFormation in CodePipeline to Create & Destroy Staging Environments"
...
- [[aws-services/10.developer/2.3.code-deploy/6.ecs-deployments|ECS Deployments]] - previous lesson
- [[aws-services/10.developer/2.3.code-deploy/x.2.1.appspec|AWS CodeDeploy appspec.yml Full Syntax & Usage Guide]] - next lesson
