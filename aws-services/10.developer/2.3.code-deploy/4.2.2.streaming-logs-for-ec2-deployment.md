...
- [[aws-services/10.developer/2.3.code-deploy/4.2.1.ec2-in-place-deployment|EC2 In Place Deployment]] - previous lesson
- [[aws-services/10.developer/2.3.code-deploy/4.2.3.ec2-deployments-with-alb|EC2 Instance Deployments Behind ALB with CodeDeploy In-Depth Guide]] - next lesson
