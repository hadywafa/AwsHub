...
## Related Notes
-[[3.2.sam-event.json|Mastering event.json in AWS SAM The Complete Guide]]] - previous lesson
-[[3.4.sam-debugging-in-details|What Happens Behind the Scenes When Debugging AWS SAM in VS Code]]] - next lesson
