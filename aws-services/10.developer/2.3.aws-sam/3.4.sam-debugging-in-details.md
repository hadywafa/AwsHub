...
## Related Notes
-[[3.3.sam-debugging|Debugging AWS SAM Applications in VS Code]]] - previous lesson
-[[3.5.sam-debugger-examples|Hands-on Tutorial Debugging AWS SAM Applications in VS Code]]] - next lesson
