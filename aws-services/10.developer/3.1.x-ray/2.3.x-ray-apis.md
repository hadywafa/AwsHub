...
- [[aws-services/10.developer/3.1.x-ray/2.2.x-ray-sampling-rules|AWS X-Ray Sampling Rules Explained]] - previous lesson
- [[aws-services/10.developer/3.1.x-ray/3.x-ray-integrations|AWS X-Ray Integration with Elastic Beanstalk ECS and Lambda]] - next lesson
