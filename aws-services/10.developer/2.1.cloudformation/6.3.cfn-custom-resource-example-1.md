...
-[[6.2.cfn-custom-resources-internals|CloudFormations Temporary HTTPS ResponseURL Behind the Scenes]]] - previous lesson
-[[6.4.cfn-custom-resource-example-2|AWS CloudFormation Custom Resource Example Creating and Managing EC2 Key Pairs]]] - next lesson
