...
## Related Notes
- [[aws-services/10.developer/1.4.aws-sam/1.serverless|The Ultimate Guide to Serverless Computing & Tools]] - previous lesson
- [[aws-services/10.developer/1.4.aws-sam/2.2.template.json|AWS SAM template.yaml]] - next lesson
