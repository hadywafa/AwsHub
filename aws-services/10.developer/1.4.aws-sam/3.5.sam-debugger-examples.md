...
## Related Notes
- [[aws-services/10.developer/1.4.aws-sam/3.4.sam-debugging-in-details|What Happens Behind the Scenes When Debugging AWS SAM in VS Code]] - previous lesson
- [[aws-services/10.developer/1.4.aws-sam/4.1.sam-deployment|AWS SAM Deployment & SAM Accelerate]] - next lesson
- [[aws-services/10.developer/1.4.aws-sam/3.3.sam-debugging|Debugging AWS SAM Applications in VS Code]] - mentions Debugging AWS SAM Applications in VS Code
