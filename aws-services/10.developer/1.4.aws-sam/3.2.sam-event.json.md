...
## Related Notes
- [[aws-services/10.developer/1.4.aws-sam/3.1.sam-local-capabilities|AWS SAM Local Capabilities]] - previous lesson
- [[aws-services/10.developer/1.4.aws-sam/3.3.sam-debugging|Debugging AWS SAM Applications in VS Code]] - next lesson
