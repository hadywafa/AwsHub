...
## Related Notes
- [[aws-services/10.developer/1.4.aws-sam/2.1.aws-sam|AWS SAM Serverless Application Model]] - previous lesson
- [[aws-services/10.developer/1.4.aws-sam/2.3.sam-policy-templates|AWS SAM Policy Templates Smart Permissions for Serverless Apps]] - next lesson
