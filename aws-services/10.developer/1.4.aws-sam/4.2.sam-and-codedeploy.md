...
## Related Notes
- [[aws-services/10.developer/1.4.aws-sam/4.1.sam-deployment|AWS SAM Deployment & SAM Accelerate]] - previous lesson
- [[aws-services/10.developer/1.4.aws-sam/4.3.sam-environments|AWS SAM Multiple Environments Dev Prod etc.]] - next lesson
