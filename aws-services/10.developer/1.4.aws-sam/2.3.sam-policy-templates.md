...
## Related Notes
- [[aws-services/10.developer/1.4.aws-sam/2.2.template.json|AWS SAM template.yaml]] - previous lesson
- [[aws-services/10.developer/1.4.aws-sam/2.4.sam.cli|AWS SAM CLI The Ultimate Guide]] - next lesson
