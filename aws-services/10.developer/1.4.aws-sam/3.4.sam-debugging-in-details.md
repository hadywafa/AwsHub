...
## Related Notes
- [[aws-services/10.developer/1.4.aws-sam/3.3.sam-debugging|Debugging AWS SAM Applications in VS Code]] - previous lesson
- [[aws-services/10.developer/1.4.aws-sam/3.5.sam-debugger-examples|Hands-on Tutorial Debugging AWS SAM Applications in VS Code]] - next lesson
