...
## Related Notes
- [[aws-services/10.developer/1.4.aws-sam/2.4.sam.cli|AWS SAM CLI The Ultimate Guide]] - previous lesson
- [[aws-services/10.developer/1.4.aws-sam/3.2.sam-event.json|Mastering event.json in AWS SAM The Complete Guide]] - next lesson
