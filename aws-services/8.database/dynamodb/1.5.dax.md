...
- [[aws-services/8.database/dynamodb/1.4.backup|AWS DynamoDB Backup]] - previous lesson
- [[aws-services/8.database/dynamodb/1.6.additional-features|AWS DynamoDB Additional Features]] - next lesson
- [[aws-services/8.database/dynamodb/ddb-in-depth/12.3.ddb-dax|DynamoDB Accelerator DAX In-Memory Caching for DynamoDB]] - mentions DynamoDB Dax
