...
- [[aws-services/8.database/aurora/3.aurora-rds-proxy|Amazon Aurora RDS Proxy Smart Connection Management]] - previous lesson
- [[aws-services/8.database/aurora/5.aurora-serveless-v2|Amazon Aurora Serverless Version 2]] - next lesson
