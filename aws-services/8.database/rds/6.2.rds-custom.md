...
tags:
  ...
  - aws/topic/rds
aliases:
  - "Amazon RDS Custom for Oracle and MS SQL"
  - "Rds Custom"
---
...
- [[aws-services/8.database/rds/6.1.rds-on-aws-outposts|Amazon RDS on AWS Outposts]] - previous lesson
- [[aws-services/8.database/rds/6.3.rds-network-types|Conclusion RDS Network Types]] - next lesson
