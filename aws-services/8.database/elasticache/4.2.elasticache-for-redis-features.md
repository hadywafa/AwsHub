...
- [[aws-services/8.database/elasticache/4.1.elasticache-redis-deployment-modes|AWS ElastiCache for Redis Deployment Modes & Best Practices]] - previous lesson
- [[aws-services/8.database/elasticache/4.3.elasticache-redis-metrics|Amazon ElastiCache for Redis Key Metrics to Monitor]] - next lesson
