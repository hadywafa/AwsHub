...
aliases:
  ...
  - "Cfn Demo Cross Stack Reference"
  - "CloudFormation Demo Cross Stack Reference"
---
...
- [[aws-services/1.management-governance/1.cloudformation/10.1.cfn-demos|AWS CloudFormation Demo - Full Infrastructure Deployment]] - previous lesson
- [[aws-services/1.management-governance/1.cloudformation/2.1.cfn-nested-stacks|AWS CloudFormation Nested Stacks]] - next lesson
- [[aws-services/1.management-governance/1.cloudformation/2.3.cfn-cross-stack-reference|Cross-Stack References in AWS CloudFormation Not Recommended - Use SSM Parameter Store Instead]] - mentions Cfn Cross Stack Reference
