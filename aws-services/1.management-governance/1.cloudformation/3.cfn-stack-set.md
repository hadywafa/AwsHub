...
- [[aws-services/1.management-governance/1.cloudformation/2.3.cfn-cross-stack-reference|Cross-Stack References in AWS CloudFormation Not Recommended - Use SSM Parameter Store Instead]] - previous lesson
- [[aws-services/1.management-governance/1.cloudformation/4.1.cfn-stack-role|AWS CloudFormation Stack Role]] - next lesson
