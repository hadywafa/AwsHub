...
- [[aws-services/1.management-governance/1.cloudformation/1.2.cfn-template-structure|AWS CloudFormation Template Structure]] - previous lesson
- [[aws-services/1.management-governance/1.cloudformation/1.4.cfn-resources-replacement|Stack Updates Causing Resource Replacement in AWS CloudFormation]] - next lesson
