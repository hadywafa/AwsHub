...
- [[aws-services/1.management-governance/1.cloudformation/1.7.cfn-mapping|AWS CloudFormation Mappings Section]] - previous lesson
- [[aws-services/1.management-governance/1.cloudformation/1.9.cfn-outputs|AWS CloudFormation Outputs Section]] - next lesson
