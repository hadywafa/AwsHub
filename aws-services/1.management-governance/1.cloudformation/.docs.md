...
- [[aws-services/1.management-governance/1.cloudformation/5.2.cfn-helper-scripts|AWS CloudFormation Helper Scripts Automating EC2 Configuration]] - mentions CloudFormation Helper Scripts
