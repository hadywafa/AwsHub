...
- [[aws-services/1.management-governance/1.cloudformation/2.2.cfn-nested-stacks-parameters|Passing Parameters in Nested Stacks with Dependencies]] - previous lesson
- [[aws-services/1.management-governance/1.cloudformation/3.cfn-stack-set|AWS CloudFormation StackSets]] - next lesson
