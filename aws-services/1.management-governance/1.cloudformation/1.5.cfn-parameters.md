...
- [[aws-services/1.management-governance/1.cloudformation/1.4.cfn-resources-replacement|Stack Updates Causing Resource Replacement in AWS CloudFormation]] - previous lesson
- [[aws-services/1.management-governance/1.cloudformation/1.6.cfn-metadata|AWS CloudFormation Metadata Section]] - next lesson
