...
tags:
  ...
  - aws/topic/config
aliases:
  - "AWS Config Track Audit and Enforce Your AWS Resource Compliance"
  - "AWS Config"
---
...
- [[aws-services/1.management-governance/4.3.config/2.config-rule|or AWS Config Rules]] - next lesson
