...
- [[aws-services/1.management-governance/4.3.config/2.config-rule|or AWS Config Rules]] - previous lesson
- [[aws-services/1.management-governance/4.3.config/4.cloud_watch-vs-cloud_trail-vs-aws_config|CloudWatch vs CloudTrail vs AWS Config]] - next lesson
