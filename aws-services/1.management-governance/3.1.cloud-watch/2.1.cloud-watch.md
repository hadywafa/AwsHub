...
- [[aws-services/1.management-governance/3.1.cloud-watch/1.2.metric-vs-logs|Metrics vs Logs Simple Explanation]] - previous lesson
- [[aws-services/1.management-governance/3.1.cloud-watch/2.2.cw-metrics-types|Amazon EC2 CloudWatch Metrics]] - next lesson
...
- [[aws-services/5.compute/1.1.ec2/9.1.ec2-monitoring|EC2 Monitoring Keep Your Instances Healthy & Happy]] - mentions Ec2 Monitoring
