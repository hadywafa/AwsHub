...
- [[aws-services/1.management-governance/4.1.system-manager/2.3.patch-manager|AWS Systems Manager Patch Manager]] - previous lesson
- [[aws-services/1.management-governance/4.1.system-manager/3.2.app-manager|AWS App Manager Unified Application Operations in AWS Systems Manager]] - next lesson
