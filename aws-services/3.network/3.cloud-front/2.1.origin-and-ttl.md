...
<div align="center" style="background-color: #ffff;border-radius: 10px;">
  <img src="images/cdn-origin-server.png" alt="Origin Server" style="border-radius: 20px; width: 60%;">
</div>
...
## Related Notes
- [[aws-services/3.network/3.cloud-front/1.cloud-front|AWS CloudFront Securely deliver content with low latency and high transfer speeds]] - previous lesson
- [[aws-services/3.network/3.cloud-front/3.1.cache-configuration|Amazon CloudFront Cache Configuration Step-by-Step Workflow]] - next lesson
