...
## Related Notes
- [[aws-services/3.network/3.cloud-front/4.4.private-distribution|Serving Private Content with CloudFront Private Distribution]] - previous lesson
- [[aws-services/3.network/3.cloud-front/6.cdn-caching-layers|CloudFront Origin Shield & Caching Layers]] - next lesson
