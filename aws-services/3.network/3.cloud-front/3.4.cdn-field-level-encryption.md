...
aliases:
  - "Amazon CloudFront Field-Level Encryption FLE"
  - "Cdn Field Level Encryption"
---
...
## Related Notes
- [[aws-services/3.network/3.cloud-front/3.3.object-invalidation|CloudFront Object/File Invalidation]] - previous lesson
- [[aws-services/3.network/3.cloud-front/3.5.origin-groups|CloudFront Origin Groups for High Availability]] - next lesson
