...
<div align="center" style="background-color: #F2F4F3;border-radius: 10px;">
    <img src="images/without-cloud-front-simple-case.png" alt="Without CloudFront" style="border-radius: 10px; width: 60%;">
</div>
...
## Related Notes
- [[aws-services/3.network/3.cloud-front/2.1.origin-and-ttl|CloudFront - Origin Server and TTL]] - next lesson
