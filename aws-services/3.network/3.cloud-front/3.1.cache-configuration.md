...
## Related Notes
- [[aws-services/3.network/3.cloud-front/2.1.origin-and-ttl|CloudFront - Origin Server and TTL]] - previous lesson
- [[aws-services/3.network/3.cloud-front/3.2.cdn-all-distribution-options|CDN Settings]] - next lesson
- [[aws-services/3.network/3.cloud-front/3.5.origin-groups|CloudFront Origin Groups for High Availability]] - mentions Origin Groups
