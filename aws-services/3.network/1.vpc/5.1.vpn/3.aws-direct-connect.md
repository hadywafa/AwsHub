...
## Related Notes
- [[aws-services/3.network/1.vpc/5.1.vpn/2.aws-vpn|AWS VPN]] - previous lesson
- [[aws-services/3.network/1.vpc/5.1.vpn/4.aws-direct-connect-gateway|AWS Direct Connect Gateway]] - next lesson
