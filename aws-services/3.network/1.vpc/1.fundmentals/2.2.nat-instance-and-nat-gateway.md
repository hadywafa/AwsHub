...
<div align="center">
  <img src="images/nat-instance.png" alt="NAT Instance Diagram" style="border-radius:10px; width: 80%;">
</div>
...
<div align="center">
  <img src="images/nat-gateway.png" alt="NAT Gateway Diagram" style="border-radius:10px; width: 80%;">
</div>
...
## 🧑🏻‍⚖️ **NAT Instance vs NAT Gateway Comparison**
...
<div align="center">
  <img src="images/nat-instance-and-nat-gateway-lab.png" alt="NAT Instance and Nat Gateway Lab" style="border-radius:10px; width: 80%;">
</div>
---

## Related Notes
- [[aws-services/3.network/1.vpc/1.fundmentals/|Index]] - folder map
- [[aws-services/3.network/1.vpc/1.fundmentals/2.1.nat-gateway|NAT Gateway]] - previous lesson
- [[aws-services/3.network/1.vpc/1.fundmentals/3.1.proxy-vs-re-proxy|Proxy vs. Reverse Proxy The Complete Guide]] - next lesson
