...
- [[aws-services/3.network/1.vpc/1.fundmentals/8.aws-local-zones|PUBG AWS Local Zones]] - previous lesson
-[[1.1.cfn|AWS CloudFormation]]] - mentions CloudFormation
- [[aws-services/1.management-governance/4.1.system-manager/1.1.system-manager|AWS Systems Manager SSM Mastering the Heart of Infrastructure Ops]] - mentions System Manager
