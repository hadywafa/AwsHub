...
- [[aws-services/3.network/1.vpc/1.fundmentals/4.2.tgw-transit-gateway|AWS Transit Gateway]] - previous lesson
- [[aws-services/3.network/1.vpc/1.fundmentals/5.2.vpc-endpoint-with-remote-network|Hybrid Access to AWS Services via VPC Endpoints From On-Prem to Cloud]] - next lesson
