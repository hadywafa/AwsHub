...
aliases:
  ...
  - "VPC Endpoint With Remote Network"
---
...
- [[aws-services/3.network/1.vpc/1.fundmentals/5.1.vpc-endpoint|AWS VPC Endpoints]] - previous lesson
- [[aws-services/3.network/1.vpc/1.fundmentals/6.ipv6-egress-only-internet-gateway|AWS IPv6 Egress-only Internet Gateway EIGW Outbound Security for IPv6]] - next lesson
