...
aliases:
  - "AWS IPv6 Egress-only Internet Gateway EIGW Outbound Security for IPv6"
...
- [[aws-services/3.network/1.vpc/1.fundmentals/5.2.vpc-endpoint-with-remote-network|Hybrid Access to AWS Services via VPC Endpoints From On-Prem to Cloud]] - previous lesson
- [[aws-services/3.network/1.vpc/1.fundmentals/7.flow-logs|AWS VPC Flow Logs Monitor Analyze Secure Your Network]] - next lesson
