...
- [[aws-services/3.network/1.vpc/1.fundmentals/7.flow-logs|AWS VPC Flow Logs Monitor Analyze Secure Your Network]] - previous lesson
- [[aws-services/3.network/1.vpc/1.fundmentals/9.aws-wavelength|AWS Wavelength 5G]] - next lesson
