...
- [[aws-services/3.network/1.vpc/1.fundmentals/3.2.bastion-host|Bastion Host in AWS]] - previous lesson
- [[aws-services/3.network/1.vpc/1.fundmentals/4.2.tgw-transit-gateway|AWS Transit Gateway]] - next lesson
