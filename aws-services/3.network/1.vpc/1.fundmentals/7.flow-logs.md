...
aliases:
  - "AWS VPC Flow Logs Monitor Analyze Secure Your Network"
  - "Flow Logs"
---
...
- [[aws-services/3.network/1.vpc/1.fundmentals/6.ipv6-egress-only-internet-gateway|AWS IPv6 Egress-only Internet Gateway EIGW Outbound Security for IPv6]] - previous lesson
- [[aws-services/3.network/1.vpc/1.fundmentals/8.aws-local-zones|PUBG AWS Local Zones]] - next lesson
