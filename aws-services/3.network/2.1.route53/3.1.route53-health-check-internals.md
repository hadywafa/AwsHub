...
aliases:
  ...
  - "Route53 Health Check Internals"
---
...
## Related Notes
- [[aws-services/3.network/2.1.route53/2.route53|AWS Route 53 Scalable DNS for Public & Private Workloads]] - previous lesson
- [[aws-services/3.network/2.1.route53/3.2.route53-health-checks-types|Route 53 Health Check Types]] - next lesson
