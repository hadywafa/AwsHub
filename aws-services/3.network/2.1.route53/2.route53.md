...
## Related Notes
- [[aws-services/3.network/2.1.route53/1.2.domain-registrar-vs-dns-provider|Domain Registrar vs DNS Service]] - previous lesson
- [[aws-services/3.network/2.1.route53/3.1.route53-health-check-internals|Deep Dive How Route 53 Health Checks Work Internally]] - next lesson
