...
## Related Notes
- [[aws-services/3.network/2.1.route53/4.route53-routing-policies|Amazon Route 53 Routing Policies]] - previous lesson
- [[aws-services/3.network/2.1.route53/x.route53-components|Comprehensive Guide to Amazon Route 53]] - next lesson
