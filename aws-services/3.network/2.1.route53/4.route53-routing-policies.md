...
# 🗺️ **Amazon Route 53 Routing Policies**

Amazon Route 53 offers a variety of routing policies to **control** `how end-users are directed to your applications`
...
<div align="center" style="background-color: #EFF2F1;border-radius: 10px;">
...
## Related Notes
- [[aws-services/3.network/2.1.route53/3.2.route53-health-checks-types|Route 53 Health Check Types]] - previous lesson
- [[aws-services/3.network/2.1.route53/5.route53-resolver|Amazon Route 53 Resolver Simple & Deep Hybrid DNS]] - next lesson
