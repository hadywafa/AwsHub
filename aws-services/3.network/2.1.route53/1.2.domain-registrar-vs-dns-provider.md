...
## Related Notes
- [[aws-services/3.network/2.1.route53/1.1.dns|DNS Domain Name System]] - previous lesson
- [[aws-services/3.network/2.1.route53/2.route53|AWS Route 53 Scalable DNS for Public & Private Workloads]] - next lesson
