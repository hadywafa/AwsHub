...
- [[aws-services/5.compute/1.3.ec2-auto-scaling/2.2.scaling-policy|Auto Scaling Policies]] - previous lesson
- [[aws-services/5.compute/1.3.ec2-auto-scaling/2.4.asg-step-2|Integrate with other services - optional]] - next lesson
