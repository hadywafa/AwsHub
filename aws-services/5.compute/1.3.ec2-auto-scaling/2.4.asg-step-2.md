...
- [[aws-services/5.compute/1.3.ec2-auto-scaling/2.3.asg-step-1|Choose instance launch options]] - previous lesson
- [[aws-services/5.compute/1.3.ec2-auto-scaling/2.5.asg-step-3|Configure group size and scaling]] - next lesson
