...
- [[aws-services/5.compute/1.3.ec2-auto-scaling/3.1.timers-and-termination-policy|EC2 Auto Scaling Timers & Termination Policy]] - previous lesson
- [[aws-services/5.compute/1.3.ec2-auto-scaling/4.2.lifecycle-hook-with-codedeploy|CodeDeploy + Auto Scaling + ALB Lifecycle Hook in Action]] - next lesson
