...
- [[aws-services/5.compute/4.1.lambda/5.2.lambda-environment-variables|AWS Lambda Environment Variables]] - previous lesson
- [[aws-services/5.compute/4.1.lambda/6.2.lambda-concurrent-execution|AWS Lambda Concurrent Execution Deep Dive]] - next lesson
