...
- [[aws-services/5.compute/4.1.lambda/6.4.lambda-recursion-detection|AWS Lambda Recursion Detection Stopping Infinite Loops]] - previous lesson
- [[aws-services/5.compute/4.1.lambda/7.2.lambda-at-edge|Customization at the Edge with CloudFront Functions & LambdaEdge]] - next lesson
-[[networking-basics|Virtual Private Cloud]]] - mentions Virtual Private Cloud
- [[aws-services/5.compute/4.1.lambda/12.lambda-pricing|AWS Lambda Pricing]] - mentions Lambda Pricing
