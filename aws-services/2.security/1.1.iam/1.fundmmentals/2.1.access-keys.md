...
<div align="center">
  <img src="image/access-to-aws.png" alt="Accessing AWS Programmatically" style="border-radius: 10px; max-width: 100%;" />
</div>
...
## Related Notes
- [[aws-services/2.security/1.1.iam/1.fundmmentals/1.3.arn|Amazon Resource Name ARN]] - previous lesson
- [[aws-services/2.security/1.1.iam/1.fundmmentals/2.2.pwsh-automate-profile-checkout|Smart AWS Profile Switching in PowerShell with Oh My Posh + FZF]] - next lesson
