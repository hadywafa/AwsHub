...
## Related Notes
- [[aws-services/2.security/1.1.iam/1.fundmmentals/1.1.aws-account|AWS Account Your Gateway to the AWS Cloud]] - previous lesson
- [[aws-services/2.security/1.1.iam/1.fundmmentals/1.3.arn|Amazon Resource Name ARN]] - next lesson
