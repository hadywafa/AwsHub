...
<div align="center">
  ...
  <!-- <img src="image/iam-policy-types.png" alt="IAM Policies Overview" style="border-radius: 20px;"> -->
</div>
...
## Related Notes
- [[aws-services/2.security/1.1.iam/1.fundmmentals/2.3.zsh-automate-aws_profile-checkout|Zsh Automate AWS Profile Checkout]] - previous lesson
- [[aws-services/2.security/1.1.iam/1.fundmmentals/4.1.iam-security-tools|IAM Security Tools in AWS]] - next lesson
- [[aws-services/2.security/1.1.iam/3.policy-evaluation-logic/1.policy-evaluation-logic|IAM Policy Evaluation Logic]] - mentions Policy Evaluation Logic
