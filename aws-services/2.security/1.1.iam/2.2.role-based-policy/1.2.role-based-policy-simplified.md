...
aliases:
  - "IAM Role Advanced Overview"
  - "Role Based Policy Simplified"
---
...
<div align="center" style="background-color: #dad5d5ff;border-radius: 10px;">
  <img src="image/iam-role-trusting-account.png" alt="IAM Role - Trusting Account Diagram" style="border-radius: 20px;" />
</div>
...
## Related Notes
- [[aws-services/2.security/1.1.iam/2.2.role-based-policy/1.1.role-based-policy|IAM Roles in AWS]] - previous lesson
- [[aws-services/2.security/1.1.iam/2.2.role-based-policy/1.3.iam-role-cross-account-access|Cross-Account IAM Roles in AWS]] - next lesson
