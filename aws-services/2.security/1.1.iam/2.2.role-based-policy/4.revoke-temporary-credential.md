...
## Related Notes
- [[aws-services/2.security/1.1.iam/2.2.role-based-policy/3.session-policy|Session Policy in AWS IAM]] - previous lesson
- [[aws-services/2.security/1.1.iam/2.2.role-based-policy/5.pass-role|IAM PassRole Granting Permission to Pass IAM Roles to AWS Services]] - next lesson
