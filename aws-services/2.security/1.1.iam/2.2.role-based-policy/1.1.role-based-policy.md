...
<div align="center" style="background-color: #f8f7f7ff;border-radius: 10px;">
  <img src="image/iam-role.png" alt="IAM Roles Overview" style="width: 60%; ">
</div>
...
<div align="center" style="background-color: #f8f7f7ff;border-radius: 10px;">
    <img src="image/iam-role-components.png" alt="IAM Role Workflow" style="width: 60%;">
</div>
...
## Related Notes
- [[aws-services/2.security/1.1.iam/2.2.role-based-policy/1.2.role-based-policy-simplified|IAM Role Advanced Overview]] - next lesson
