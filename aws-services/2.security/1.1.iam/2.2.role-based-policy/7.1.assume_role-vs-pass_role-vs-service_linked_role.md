...
aliases:
  - "Assume Role Vs Pass Role Vs Service Linked Role"
---
...
## Related Notes
- [[aws-services/2.security/1.1.iam/2.2.role-based-policy/6.service-linked-role|Service-Linked Roles Simplified]] - previous lesson
- [[aws-services/2.security/1.1.iam/2.2.role-based-policy/7.2.hands-on-assume_role-vs-pass_role-vs-service_linked_role|Hands-on guide for all three role types]] - next lesson
...
- [[aws-services/2.security/1.1.iam/2.2.role-based-policy/5.pass-role|IAM PassRole Granting Permission to Pass IAM Roles to AWS Services]] - mentions Pass Role
