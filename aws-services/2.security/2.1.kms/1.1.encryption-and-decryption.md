...
## Related Notes
- [[aws-services/2.security/2.1.kms/.kms-summary|KMS Summary]] - previous lesson
- [[aws-services/2.security/2.1.kms/1.2.envelope-encryption|There are two uses of asymmetric + symmetric encryption but they are not the same thing]] - next lesson
