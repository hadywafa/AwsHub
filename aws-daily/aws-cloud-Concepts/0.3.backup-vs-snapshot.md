...
## Related Notes
- [[aws-daily/aws-cloud-Concepts/0.2.whitelisting-vs-blacklisting|Whitelisting vs Blacklisting]] - previous lesson
- [[aws-daily/aws-cloud-Concepts/1.1.key-architecture-pillars|Essential Cloud Architecture Concepts Explained Simply]] - next lesson
- [[aws-services/8.database/rds/4.1.backup-vs-snapshot|Root Difference Between Taking a Snapshot and Backup for Microsoft SQL Server]] - mentions Backup Vs Snapshot
